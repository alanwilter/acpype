#!/usr/bin/env python
from acpype_lib.acpype import _getoutput
...
groupResults = [
    ...
    [
        ...
        [
            ...
            "0 E, 2 W, ET , WT _0_1",
            "0 E, 2 W, ET , WT _0_2",
            "0 E, 3 W, ET , WT _0_1_2",
            "0 E, 2 W, ET , WT _0_3",
            "0 E, 3 W, ET , WT _0_1_3",
            "0 E, 3 W, ET , WT _0_2_3",
            "0 E, 4 W, ET , WT _0_1_2_3",
            "0 E, 2 W, ET , WT _0_8",
        ],
    ],
    [
        "only guessCharge failed, but running semi-QM with charge = 0 finished fine",
        "Mols only guessCharge failed",
        [
            "1 E, 1 W, ET _0, WT _0",
            "1 E, 2 W, ET _0, WT _0_1",
            "1 E, 2 W, ET _0, WT _0_2",
            "1 E, 3 W, ET _0, WT _0_1_2",
        ],
    ],
    [
        "atoms in close contact",
        "Mols have atoms in close contact",
        [
            "0 E, 2 W, ET , WT _0_7",
            "0 E, 3 W, ET , WT _0_1_7",
            "0 E, 3 W, ET , WT _0_2_7",
            "0 E, 3 W, ET , WT _0_3_7",
            "0 E, 4 W, ET , WT _0_1_2_7",
            "0 E, 4 W, ET , WT _0_1_3_7",
            "0 E, 4 W, ET , WT _0_2_3_7",
            "0 E, 5 W, ET , WT _0_1_2_3_7",
        ],
    ],
    [
        "irregular bonds",
        "Mols have irregular bonds",
        [
            "0 E, 2 W, ET , WT _0_5",
            "0 E, 3 W, ET , WT _0_1_5",
            "0 E, 3 W, ET , WT _0_2_5",
            "0 E, 4 W, ET , WT _0_1_2_5",
        ],
    ],
    [
        "irregular bonds and atoms in close contact",
        "Mols have irregular bonds and atoms in close contact",
        [
            "0 E, 3 W, ET , WT _0_5_7",
            "0 E, 4 W, ET , WT _0_1_5_7",
            "0 E, 4 W, ET , WT _0_2_5_7",
            "0 E, 5 W, ET , WT _0_1_2_5_7",
            "0 E, 6 W, ET , WT _0_1_2_3_5_7",
            "0 E, 4 W, ET , WT _0_3_5_7",
        ],
    ],
    [
    ...
    [
        ...
        "Mols have missing parameters and atoms in close contact",
        ["0 E, 4 W, ET , WT _0_1_4_7"],
    ],
    [
        "missing parameters, irregular bonds and atoms in close contact",
        "Mols have missing parameters, irregular bonds and atoms in close contact",
        ["0 E, 5 W, ET , WT _0_2_4_5_7"],
    ],
    [
        "missing parameters, irregular bonds, maybe wrong atomtype and atoms in close contact",
    ...
    [
        ...
        [
            ...
            "0 E, 4 W, ET , WT _0_1_3_6",
            "0 E, 3 W, ET , WT _0_3_6",
        ],
    ],
    [
    ...
    [
        ...
        "Mols with irregular bonds, maybe wrong atomtype and atoms in close contact",
    ...
    [
        ...
        "Mols have guessCharge failed and missing parameters",
        [
            "1 E, 2 W, ET _0, WT _0_4",
            "1 E, 3 W, ET _0, WT _0_1_4",
            "1 E, 3 W, ET _0, WT _0_2_4",
            "1 E, 4 W, ET _0, WT _0_1_2_4",
        ],
    ],
    [
        "guessCharge failed and maybe wrong atomtype",
        "Mols have guessCharge failed and maybe wrong atomtype",
        [
            "1 E, 2 W, ET _0, WT _0_6",
            "1 E, 3 W, ET _0, WT _0_1_6",
            "1 E, 3 W, ET _0, WT _0_2_6",
            "1 E, 4 W, ET _0, WT _0_1_2_6",
        ],
    ],
    [
        "guessCharge failed and irregular bonds",
        "Mols have guessCharge failed and irregular bonds",
    ...
    [
        ...
        "Mols have guessCharge failed, irregular bonds and maybe wrong atomtype",
        ["1 E, 4 W, ET _0, WT _0_2_5_6", "0 E, 3 W, ET , WT _0_5_6"],
    ],
    [
        "guessCharge failed, missing parameters and atoms in close contact",
        "Mols have guessCharge failed, missing parameters and atoms in close contact",
        ["1 E, 3 W, ET _0, WT _0_4_7", "1 E, 4 W, ET _0, WT _0_2_4_7"],
    ],
    [
        "guessCharge failed, maybe wrong atomtype and atoms in close contact",
        "Mols have guessCharge failed, maybe wrong atomtype and atoms in close contact",
        [
            "1 E, 3 W, ET _0, WT _0_6_7",
            "1 E, 4 W, ET _0, WT _0_1_6_7",
            "1 E, 4 W, ET _0, WT _0_2_6_7",
            "1 E, 5 W, ET _0, WT _0_1_2_6_7",
        ],
    ],
    [
        "guessCharge failed, irregular bonds and atoms in close contact",
        "Mols have guessCharge failed, irregular bonds and atoms in close contact",
        ["1 E, 4 W, ET _0, WT _0_2_5_7"],
    ],
    [
        "guessCharge failed, irregular bonds, maybe wrong atomtype and atoms in close contact",
        "Mols have guessCharge failed, irregular bonds, maybe wrong atomtype and atoms in close contact",
    ...
    [
        "guessCharge and tleap failed",
        "Mols have guessCharge and tleap failed",
        ["4 E, 1 W, ET _0_4_5_6, WT _0", "4 E, 2 W, ET _0_4_5_6, WT _0_1"],
    ],
    [
        "guessCharge and tleap failed, maybe wrong atomtype",
        "Mols have guessCharge and tleap failed, maybe wrong atomtype",
        ["4 E, 2 W, ET _0_4_5_6, WT _0_6", "4 E, 3 W, ET _0_4_5_6, WT _0_1_6"],
    ],
    [
        "guessCharge failed and semi-QM timeout",
        "Mols have guessCharge failed and semi-QM timeout",
        ["2 E, 1 W, ET _0_9, WT _0"],
    ],
    [
        "atoms with same coordinates and maybe wrong atomtype",
        "Mols have atoms with same coordinates and maybe wrong atomtype",
        ["1 E, 1 W, ET _1, WT _6"],
    ],
    [
        "atoms too close and maybe wrong atomtype",
        "Mols have atoms too close and maybe wrong atomtype",
        ["1 E, 1 W, ET _2, WT _6"],
    ],
    [
        "atoms too alone and maybe wrong atomtype",
        "Mols have atoms too alone and maybe wrong atomtype",
        ["1 E, 1 W, ET _3, WT _6"],
    ],
    [
        "atoms with same coordinates and too close",
        "Mols have atoms with same coordinates and too close",
        ["2 E, 0 W, ET _1_2, WT "],
    ],
    [
        "atoms with same coordinates and too alone",
        "Mols have atoms with same coordinates and too alone",
        ["2 E, 0 W, ET _1_3, WT "],
    ],
    [
        "atoms with same coordinates, too alone and maybe wrong atomtype",
        "Mols have atoms with same coordinates, too alone and maybe wrong atomtype",
        ["2 E, 1 W, ET _1_3, WT _6"],
    ],
    [
        "atoms with same coordinates, too close and too alone",
        "Mols have atoms with same coordinates, too close and too alone",
...
for molDir in ccpCodes:
    ...
    if countPdbMol2 > 2:
        multPdbMol2.append(molDir)
    if not pdbMol2:
        missPdbMol2.append(molDir)
    if not idealMol2:
        missIdealMol2.append(molDir)
    if not pdb:
        failedPdb.append(molDir)
    if not ideal:
        failedIdeal.append(molDir)
    if not pdb and not ideal:
        failedBoth.append(molDir)
...
nGJobs = 0
for item in list(execTime.items()):
    mol, tDict = item
    if "pdb" in tDict:
