...
#	libraries for the 2002 extra-point force field
#
#
#    nucleic acids..
#
loadAmberPrep all_nuc02EP.in
#
a = { DA5  DT5  DG5  DC5  } 
b = { DA3  DT3  DG3  DC3  } 
c = { RA5  RU5  RG5  RC5  } 
...
set   RCN     tail       null
#
saveOff a ./all_nucleic02EP.lib
saveOff b ./all_nucleic02EP.lib
saveOff c ./all_nucleic02EP.lib
saveOff d ./all_nucleic02EP.lib
saveOff e ./all_nucleic02EP.lib
saveOff f ./all_nucleic02EP.lib
saveOff g ./all_nucleic02EP.lib
saveOff h ./all_nucleic02EP.lib
#
#    amino acids..
#
################################################
...
clearVariables
#
# Extract the amino acids from all_amino02EP
#
loadAmberPrep all_amino02EP.in 
...
loadAmberPrep all_aminont02EP.in N
...
saveOff a ./all_aminont02EP.lib 

#
# Extract the C terminus residues
#

loadAmberPrep all_aminoct02EP.in C
