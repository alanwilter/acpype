...
This is a modified version of the Chemistry::Atom module provided
in the Chemistry perl package (see http://www.perlmol.org).
The functionality of Chemistry::Atom was extended, such that the
module can now also handle the atom type as an additional attribute.
This functionality extension was implemented to allow a matching of
atoms by type instead of symbol by the atom_matching.pm module of FEW.

Atom type can be retrieved by: $atom->get_type();

Original version of Chemistry::Atom that was modified:
Atom.pm,v 1.41 2005/05/20 19:01:04 itubert Exp, Version='0.35'

Date of last modification: 06/11/2013
